  ...
  <div class="footer-middle container">
    ...
    <div class="col-md-3 col-sm-4">
      ...
      <div class="contacts-info">
        ...
        <div class="phone-footer"><i class="phone-icon">&nbsp;</i> 01639.27.72.72</div>
        <div class="email-footer"><i class="email-icon">&nbsp;</i>quocthonght95@gmail.com</div>
      </div>
    </div>
  </div>
  <div class="footer-bottom container">
    <div class="col-sm-5 col-xs-12 coppyright"> &copy; 2017 quocthonght95@gmail.com. All Rights Reserved.</div>
